              ...
              <Card>
                <CardContent className="pt-4 md:pt-6">
                  ...
                  <div className="space-y-3">
                    ...
                    {/* Commodity */}
                    {load.commodity && (
                      <div className="flex items-center gap-2 p-2 md:p-3 rounded-md bg-navy-lighter border border-gray-700">
                        <Package className="h-4 w-4 text-gray-400 flex-shrink-0" />
                        <div className="flex-1">
                          <p className="text-xs text-gray-400">Commodity</p>
                          <p className="text-xs md:text-sm text-white">{load.commodity}</p>
                        </div>
                      </div>
                    )}
                  </div>
